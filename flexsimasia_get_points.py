...
def check_anti_cc() -> dict:
    ...
    home_page = "https://www.flexsimasia.com/forum.php"
...
def login(username: str, password: str) -> req_Session:
    headers = {
        "user-agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.88 Safari/537.36",
        "origin": "https://www.flexsimasia.com",
        "referer": "https://www.flexsimasia.com/forum.php",
    }
...
def print_current_points(s: req_Session):
    test_url = "https://www.flexsimasia.com/forum.php"
    res = s.get(test_url)
    res.raise_for_status()
    res.encoding = "utf-8"
